######################################################################
# This test shows the typcial Dual Fetch -> Decode -> Issue -> Execute
# Cycle of the processor. No type of Hazard are introduced.
######################################################################
...
remove_wave { {FILL} {DATA_OUT_LS} {INSTR_BLOCK_OUT_LS} {RESULT_PACKET_EVEN_OUT} {RESULT_PACKET_ODD_OUT} {LS_PC_OUT_EXE} {LS_WE_OUT_EOP} {LS_RIB_OUT_EOP} {LS_DATA_OUT_EOP} {LS_ADDR_OUT_EOP} {CLK_PERIOD} }
