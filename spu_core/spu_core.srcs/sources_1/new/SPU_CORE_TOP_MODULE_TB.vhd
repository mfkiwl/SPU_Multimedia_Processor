...
begin    
    ...
    begin         
        ...
        -- Add Word
        EVEN_OPCODE   <= STD_LOGIC_VECTOR(to_unsigned(16#C0#, OPCODE_WIDTH));
        RA_EVEN_ADDR  <= STD_LOGIC_VECTOR(to_unsigned(5, ADDR_WIDTH));
        RB_EVEN_ADDR  <= STD_LOGIC_VECTOR(to_unsigned(5, ADDR_WIDTH));
        EVEN_REG_DEST <= STD_LOGIC_VECTOR(to_unsigned(6, ADDR_WIDTH));
        ...
        EVEN_REG_DEST <= STD_LOGIC_VECTOR(to_unsigned(7, ADDR_WIDTH));
